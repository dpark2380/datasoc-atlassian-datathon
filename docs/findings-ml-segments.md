...
Actions, Collaborators, Integrations Used), standardized, for k = 2
through 6, and measured cluster separation with silhouette score:
...
|---|---|---|
| Low engagement | 3,232 | Low on both usage volume and integration depth |
| Active, shallow integration | 2,268 | High usage volume, low integration depth |
| Integration-heavy, moderate usage | 1,838 | Moderate usage volume, high integration depth |
| Power users | 982 | High on both usage volume and integration depth |
...
We ran Isolation Forest on the same five standardized metrics, with 5%
...
Only 21.9% of those 416 were already flagged At Risk by the quartile
